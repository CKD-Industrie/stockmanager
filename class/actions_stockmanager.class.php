...
/**
 * \file    htdocs/stockmanager/class/actions_stockmanager.class.php
...
/**
 * Class ActionsStockManager
 */
class ActionsStockManager extends CommonHookActions
{
	/**
	...
	// 	global $arrayofaction, $langs, $conf, $user;

	// 	$error = 0; // Error counter
	// 	$disabled = 1;

	// 	$label = img_picto('', 'docs', 'class="pictofixedwidth"').$langs->trans('CreateMoreOrderList');
	// 	$code = 'CREATE_MOREORDERLIST';

	// 	/* print_r($parameters); print_r($object); echo "action: " . $action; */
	// 	if (in_array($parameters['currentcontext'], array('somecontext1', 'somecontext2'))) {		// do something only for the context 'somecontext1' or 'somecontext2'
	// 		// $this->resprints = '<option value="'.$code.'" data-html="'.dol_escape_htmltag($label).'">'.$label.'</option>';
