...
/**
 * 	\defgroup   stockmanager     Module StockManager
 *  \brief      StockManager module descriptor.
 *
 *  \file       htdocs/stockmanager/core/modules/modStockManager.class.php
 *  \ingroup    stockmanager
 *  \brief      Description and activation file for module StockManager
 */
include_once DOL_DOCUMENT_ROOT.'/core/modules/DolibarrModules.class.php';

/**
 *  Description and activation class for module StockManager
 */
class modStockManager extends DolibarrModules {
	/**
	...
	public function __construct($db) {
		...
		$this->rights_class = 'stockmanager';

		// Family can be 'base' (core modules),'crm','financial','hr','projects','products','ecm','technic' (transverse modules),'interface' (link with external tools),'other','...'
		// It is used to group modules by family in module setup page
		$this->family = 'CKD-Tools';
		...
		$this->description = $langs->trans('ModuleStockManagerDesc');
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = $langs->trans('ModuleStockManagerDescLong');

		// Author
		$this->editor_name = 'Clément Jaunay';
		$this->editor_url = 'https://www.ckd-industrie.com';
		...
		$this->url_last_version = 'https://raw.githubusercontent.com/CKD-Industrie/modules-version/main/'.$this->rights_class.'.txt';
		...
		$this->dirs = array('/'.$this->rights_class.'/temp');

		// Config pages. Put here list of php page, stored into mymodule/admin directory, to use to setup module.
		$this->config_page_url = array('setup.php@'.$this->rights_class);

		// Dependencies
		// A condition to hide module
		// $this->hidden = getDolGlobalInt('MODULE_STOCKMANAGER_DISABLED'); // A condition to disable module;
		...
		$this->langfiles = array($this->rights_class.'@'.$this->rights_class);
		...
		if (!isModEnabled('stockmanager')) {
			$conf->stockmanager = new stdClass();
			$conf->stockmanager->enabled = 0;
		}
		...
		*/
		...
		// );
		/* END TOPMENU MYOBJECT */

		/* BEGIN LEFTMENU MYOBJECT */
		// Bold left menu entry
		/*
		$this->menu[$r++]=array(
		...
		*/
		/* END LEFTMENU MYOBJECT */
		/* END MENU */


		/* BEGIN EXPORT MYOBJECT */
	...
	public function init($options = '') {
		...
		// $result = $this->_load_tables('/install/mysql/', 'stockmanager');
		// $result = $this->_load_tables('/stockmanager/sql/');
		// if ($result < 0) {
